...
> **Beta status:** `v0.1.0-beta.2.3` is the current public beta. Its pre-1.0 compatibility contract may change in later releases.
...
```sh
curl -fsSL https://raw.githubusercontent.com/patrick-gitit/intelli-repo/v0.1.0-beta.2.3/install.sh | sh
```
